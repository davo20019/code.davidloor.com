...
export const metadata = {
  ...
  description: "A small studio of coding and system-design problems. Python and JavaScript, in your browser.",
};
    ...
    <header className="border-b border-rule">
      <div className="max-w-6xl mx-auto px-6 py-5 flex items-baseline justify-between gap-6">
        ...
        <nav className="text-[12px] uppercase tracking-[0.16em] text-ink-dim flex gap-5">
          <a href="/problems/" className="hover:text-rust transition-colors">Problems</a>
          <a
  ...
  return (
    <footer className="mt-24 border-t border-rule">
      <div className="max-w-6xl mx-auto px-6 py-8 flex flex-col sm:flex-row gap-4 sm:items-baseline sm:justify-between text-[11px] uppercase tracking-[0.16em] text-ink-dim">
        <span>
          Set in <span className="font-display italic normal-case tracking-normal text-ink">Fraunces</span>,{" "}
          Inter Tight, &amp; JetBrains Mono.
        </span>
        <span>
          Open source · MIT ·{" "}
          <a href="https://github.com/davidloor/code.davidloor.com" className="hover:text-rust transition-colors">
            fork on GitHub
          </a>
        </span>
      </div>
